...
\title{Kant and Modern Mathematic}
...
When I was young, I read Kant's \emph{Prolegomena} where he outlines his ideas for his main book
\emph{Critique of Pure Reason}. In his Prolegomena, he outlines the following ``pure concepts of
understanding'':
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/transcendent_table_of_concepts_of_the_understanding.png}
        \caption{Kant's pure concepts of understanding}
        \label{fig:transcendent_table_of_concepts_of_the_understanding}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/logical_table_of_judgments.png}
        \caption{Kant's logical table of judgments}
        \label{fig:logical_table_of_judgments}
    \end{subfigure}
    \caption{Side-by-side figures of Kant's tables.}
    \label{fig:kant_tables_side_by_side}
\end{figure}

These ideas stuck when I started studying mathematics; I couldn't help but draw parallels to modern mathematical
thinking to these concepts. In this article, I will flesh out my thoughts intersecting these fields.
