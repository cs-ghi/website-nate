...
// Posts. Rendered order comes from the PDF compile dates in the manifest (or
// `intendedDate` for planned entries), so this array's order is not load-bearing.
//
...
export const BLOG_POSTS: BlogEntry[] = [
  ...
  },
  {
    ...
    desc: 'Many may have heard the tantalizing claim that quadratic reciprocity is the simplest version of Langland\'s reciprocity. In this quick article, I give an overview of the build-up towards it by going through Artin\'s reciprocity.',
