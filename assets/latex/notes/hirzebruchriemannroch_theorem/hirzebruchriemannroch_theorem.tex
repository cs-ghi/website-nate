...
\]
This result is proven in~\cref{th:rrForRiemannSurfaceandLineBundles}. As we phrased the Riemann-Roch
...
\[
  \deg(\CL) = c(\CL)[X] \in \Z
\]
Then~\cref{th:rrForRiemannSurfaceandLineBundles} becomes:
\begin{align*}
...
\textcolor{red}{This next result will definitely require some characteristic theory}.
